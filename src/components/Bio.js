    ...
    return (
        <div className="bio">
            ...
            <div className='bio-parent'>
                ...
                <div className='bio-child'>
                    <h2>What I do</h2>
                    <p>Currently, what I'm doing is looking for a job! The roles in which I'm most interested are: Technical Program Manager, Product Manager, or Software Developer.</p>
                    <p>I started out working in events at a production facility, hosting music nights, film premieres, classes, album launches, and more. After a few years, I was promoted to working on the Operations team, supporting the global network of production sites. After about five years at that company, I decided it was time for a change. I quit my job (leaving a team I loved dearly), put almost all of my possessions in storage, and drove across the country.</p>
