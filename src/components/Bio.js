    ...
    return (
        <div className="bio">
            ...
            <div className='bio-parent'>
                ...
                <div className='bio-child'>
                    <h2>What I do</h2>
                    <p>I started out working in events at a production facility, and eventually was promoted to working on the Operations team, supporting our global network of production sites. Much of my energy was focused on tools and processes – and making sure the work I did could apply to teams and users at all of our global locations. After about five years at that job, I decided it was time for a change. I quit my job (leaving a team I loved dearly), put almost all of my possessions in storage, and drove across the country.</p>
                    <p>Once I got resettled, I joined a startup that focused on making creative fulfillment attainable for everyone. While there, more and more of my work involved me increasing my technical skills. I even started using VS Code to update our codebase with new class launches and bug fixes. It was empowering to be able to make changes myself, and that made me realize that I wanted to sign up for a software bootcamp.</p>
            ...
            <div className='bio-parent'>
                <div className='bio-child'>
                    ...
                    <p>I excel at building cross-functional relationships and communicating between different teams. I love the challenges of program management – balancing requests from multiple stakeholders, creating and improving processes, and ensuring all deliverables are fulfilled in a timely manner with a fantastic attitude. I love learning the ins and outs of new tools and I find satisfaction in making processes more efficient.</p>
                    <p>I'm eager to implement my new software engineering skills wherever I can. The ability to build new features, improve user journeys from a process AND UX perspective, and continue learning technical lessons makes me really excited for whatever comes next.</p>
                    <p>I think the world is so much more vibrant with art and creativity and connection – and I can't wait to see how I can incorporate those into my next role.
                    </p>
                    </div>
